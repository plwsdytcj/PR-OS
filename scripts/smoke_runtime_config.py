...
def main() -> None:
    ...
    for text in ["Campaign Room", "Workspace", "数据源设置", "smoke_data_sources.py", "smoke_storage_adapter.py"]:
        assert text in readme
    for text in ["db/postgres_schema.sql", "migrate_sqlite_to_postgres.py", "smoke_postgres_runtime.py", "docker compose up", "DATABASE_URL"]:
        assert text in readme
