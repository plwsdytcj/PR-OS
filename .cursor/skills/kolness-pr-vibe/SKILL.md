...
| 标签卡 | Brief 匹配与风险 | **微信式** `personal_tags` + 归类确认层；`industry_fit_tags`, `identity_tags`, `content_capability_tags`, `delivery_tags`, `suitable_goals`, `risk_tags`, `narrative_position` |
